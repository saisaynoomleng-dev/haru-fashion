  ...
  return (
    <Bounded>
      <div className="grid grid-cols-6 md:grid-cols-12 leading-[1] gap-1 md:gap-2 add-padding">
        ...
        <LetterTextFlow className="text-[2.3rem] sm:text-[3.8rem] md:text-[5rem] lg:text-[7rem] col-start-1 row-start-2 col-end-7 md:col-end-11 relative z-20 uppercase">
          One brand
        </LetterTextFlow>

        <ImageFillIn className="relative z-10 col-start-4 col-end-7 row-start-2 row-end-5 md:col-start-7 md:col-end-13">
          <Image
        ...
        <SlideInEffect
          direction="top"
          className="col-start-1 row-start-5 uppercase text-right"
        >
          <p>With</p>
        </SlideInEffect>
        ...
        <ImageFillIn className="col-start-1 col-end-5 row-start-7 row-end-10 md:col-end-9 place-self-center">
          <Image
        ...
        <ImageFillIn className="col-start-5 col-end-7 row-start-7 row-end-9 md:col-start-9 md:col-end-13">
          <Image
        ...
        <LineTextFlowEffect className=" col-start-5 row-start-9 col-end-7 md:col-start-9 md:col-end-13 row-end-10">
        ...
        <LineTextFlowEffect className="md:col-start-5 md:col-end-9 row-start-10 col-start-2 col-end-5">
      ...
      <div className="grid grid-cols-3 md:grid-cols-6 gap-3 md:gap-5 bg-brand-black text-brand-white px-3 py-5 md:px-5 md:py-7 add-padding">
        <SlideInEffect
          direction="top"
          className="text-fs-400 md:text-fs-500 lg:text-fs-600 col-start-1 col-end-2 md:col-end-3 uppercase text-center"
        >
          <p>Haru in Numbers</p>
        </SlideInEffect>
        ...
        <div className="col-start-2 row-start-2 md:col-start-3 text-fs-200 text-white/50 text-center">
          <p>
            <TextCounter
              inner={500}
              className="text-fs-400 md:text-fs-500 lg:text-fs-600 text-white"
            >
              0
            </TextCounter>
            +
      ...
      <div className="grid grid-cols-6 md:grid-cols-12 md:grid-rows-[300px_auto_auto_auto] grid-rows-[80px_auto_auto_auto] add-padding">
        <SlideInEffect
          direction="left"
          className="text-[5rem] md:text-[18rem] lg:text-[20rem] col-start-1 col-end-3 md:col-end-7 place-self-start text-black/40"
        >
          <p>40</p>
        </SlideInEffect>
        ...
        <SlideInEffect
          direction="right"
          className="text-[1.5rem] md:text-[3rem] lg:text-[4rem] row-start-2 col-start-2 uppercase leading-[1] md:col-start-4 lg:col-start-5 lg:col-end-8 col-end-3 md:col-end-7"
        >
          <p>Year jubilee</p>
        </SlideInEffect>

        <LineTextFlowEffect className="col-start-1 col-end-4 text-[0.7rem] md:col-start-2 md:col-end-6 row-start-3">
          This year Haru&reg; turned 40 years old and we celebrated this event
          with a corresponding scale.
        </LineTextFlowEffect>

        <LineTextFlowEffect className="col-start-2 col-end-5 md:col-start-4 md:col-end-8 lg:col-start-5 row-start-4 text-[0.7rem] relative z-20">
      ...
      <div className="grid gap-2 add-padding text-fs-200 md:grid-cols-3 px-5">
        ...
        <LineTextFlowEffect className="uppercase text-center col-span-full">
        ...
        <div className="flex flex-col gap-2 md:col-start-2 md:col-end-3">
          <ImageFillIn className="max-md:place-self-center">
            <Image
